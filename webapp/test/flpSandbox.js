		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#assignment1assignment1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assignment1assignment1-display": {
								"semanticObject": "assignment1assignment1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assignment1.assignment1",
									"url": sap.ui.require.toUrl("assignment1/assignment1")
								}
							}
						}
					}
